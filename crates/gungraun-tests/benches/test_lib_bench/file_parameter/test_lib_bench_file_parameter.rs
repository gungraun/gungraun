...
#[library_benchmark]
#[benches::one_line(file = "crates/gungraun-tests/benches/fixtures/one_line.fix")]
fn one_line(value: String) {
    assert_eq!(value, "1".to_owned());
}

#[library_benchmark]
#[benches::one_line(file = "crates/gungraun-tests/benches/fixtures/one_line.fix", setup = string_to_u64)]
fn one_line_with_setup(value: u64) {
    assert_eq!(value, 1);
}

#[library_benchmark]
#[benches::two_lines(file = "crates/gungraun-tests/benches/fixtures/two_lines.fix")]
...
#[library_benchmark]
#[benches::two_lines(
    file = "crates/gungraun-tests/benches/fixtures/two_lines.fix",
    setup = string_to_u64
)]
